...
<head>
  ...
  <link rel="stylesheet" href="style-edit-pasien.css">
  ...
  <div class="main-container">
    ...
    <div class="container">
      ...
      <div class="right-side">
        <h1 class="judul">Edit Pasien</h1>
        <?php
            $koneksi = mysqli_connect("localhost","root","","uas_web");
            $id = $_GET['id'];
            $edit  = "SELECT * FROM pasien WHERE id_pasien='$id'";
            $hasil = mysqli_query($koneksi,$edit);
            $data = mysqli_fetch_array($hasil);
        
        ?>
        <div class="form-edit">
            <form method="POST" action="update-pasien.php" class="container-edit">
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <div class="nama">
                    Nama Pasien<input type="text" class="input" name="nama" value="<?php echo $data['nama_pasien']; ?>">
                </div>
                <div class="tanggal">
                ...
                <div class="kamar">
                  Kamar<input type="text" class="input" name="kamar" value="<?php echo $data['kamar']; ?>">
                </div>  
